...
faqs:
  ...
  - question: "Can a quarter have just one theme?"
    answer: "Yes — and often it's the right call. If something significant is happening (a launch, a move, a major change), pour the whole quarter at it. The cap of three is a maximum, not a target. The goal is fewer themes, not three of them."
  - question: "What if I miss running the wizard at the start of the quarter?"
    answer: "Run it now. Quarters in Focus Mode One aren't synced to the calendar — they're personal thirteen-week cycles that start when you start them. A late quarter is a quarter; a never-run quarter is just last quarter on autopilot."
related:
