---
title: "Why Your To-Do List Keeps Lying to You"
description: "To-do lists optimise for closure, not direction. They fill up and stay full because the unit of planning is wrong. Here's what's actually broken and what to do instead."
pubDate: 2026-05-16
targetQuery: "to do list not working"
fm1Angle: "The anti-to-do-list thesis FM1 owns. Anchors positioning across the whole property — the line every other FM1 article will eventually link back to."
excerpt: "To-do lists optimise for closure, not direction. They fill up because the unit of planning is wrong. Here's what's actually broken — and the planning surface that does what a list can't."
quickAnswer: "To-do lists optimise for closing tasks, not making progress. Each item is a small loop that opens when you write it down and closes when you check it off — the system runs on the feeling of clearing things, not on whether the cleared things mattered. Direction needs a different surface."
faqs:
  - question: "Should I delete my to-do list entirely?"
    answer: "No — you'll still need somewhere to capture the residue. Errands, follow-ups, things to remember. Just stop asking it the question it can't answer, which is 'what should I work on?' Use it as a secondary surface for unrelated items, not the place where your week takes shape."
  - question: "Won't a planning system add more overhead than a simple list?"
    answer: "Less, in practice. A planning surface answers questions you're already trying to answer — what is this week for, what is this quarter for — and it answers them in one place instead of on Mondays, on Sundays, in your head at 3am. The total time spent is lower."
  - question: "What about urgent ad-hoc tasks that don't fit a plan?"
    answer: "They live on the supporting slots — the residue layer under the plan. Three priorities, six supporting. The urgent ad-hoc thing is one of the six. The plan doesn't ignore reactive work; it just stops letting reactive work fill the slots that should belong to directional work."
related:
  - three-planning-horizons-quarter-week-day
  - productivity-apps-vs-planning-apps
---
